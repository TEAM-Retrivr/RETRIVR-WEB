...
type ProfileChangeExitConfirmModalProps = {
  isOpen: boolean;
  onClose: () => void;
  onConfirmExit: () => void;
};

const ProfileChangeExitConfirmModal = ({
  isOpen,
  onClose,
  onConfirmExit,
}: ProfileChangeExitConfirmModalProps) => (
  <Modal
    isOpen={isOpen}
    onClose={onClose}
    showTitle={false}
...
export default ProfileChangeExitConfirmModal;
