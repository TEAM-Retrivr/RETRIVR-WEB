...
import { ADMIN_PRIVACY_SECTIONS } from "../../constants/legalContent";

const AccountPrivacyPage = () => {
  return (
    <Layout>
      <Header name="계정 관리" pageName="개인정보 처리방침" backTo="/account" />
      <div className="flex flex-1 flex-col overflow-y-auto no-scrollbar bg-neutral-white font-[Pretendard]">
        <div className="mx-4 mt-5 rounded-[16px] bg-[#F8F9F9] px-8 py-9 shadow-[inset_0_0_10px_rgba(0,0,0,0.05)]">
          <h1 className="pb-0.5 text-18px font-bold text-neutral-gray-1">
            개인정보 처리방침
          </h1>
